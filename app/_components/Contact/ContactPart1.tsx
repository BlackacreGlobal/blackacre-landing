...
const ContactPart1 = () => {
  return (
    <div className="w-full max-w-[64rem] flex flex-col items-center mx-auto">
      ...
      <button className="w-full px-6 max-w-[102px] py-2 bg-[#161616] mt-3 rounded-md hover:bg-white hover:text-black font-medium transition duration-300 ease-in-out transform hover:scale-105">
        Submit
      </button>
    </div>
  );
